...
| 버전 | 주요 변경 |
|------|-----------|
| **v4.1.0** | 전체 UI 다국어(i18n) 지원 (한국어, 영어, 일본어, 중국어 간체/번체) |
| v4.0.1 | 내 후원 탭 UI 개선 (차트 상단 고정, 데이터 안내 배너) |
| v4.0.0 | 내 후원 탭 추가 (별풍선 현황, 충전/선물 내역, 방송국 후원) |
...
| 버전 | 주요 변경 |
|------|-----------|
| v4.1.x | 전체 UI 다국어(i18n) 지원 (5개 언어) |
| v4.0.x | 내 후원 탭 (별풍선 현황, 스트리머별 선물 통계, 방송국 후원) |
