...
| v3.6.5 | 분할 녹화 크기 설정 기능 추가 (500MB/1GB/2GB) |
| v3.6.4 | isSaving 변수 미정의 핫픽스 - 500MB 분할 녹화 복구 |
| v3.6.3 | 분할 녹화 시 requestData 인터벌 관리 수정 (분할 전 중지 → 분할 후 재시작) |
| v3.6.2 | 500MB 분할 녹화 수정 - requestData 인터벌 추가로 Canvas 스트림 데이터 수집 정상화 |
| v3.6.1 | Extension Context Invalidation 오류 수정 |
| v3.6.0 | GA4 익명 통계 수집 기능 추가 |
