...
| v3.5.20 | 코드 리뷰 보완: 스트리머 순서 저장, Blob URL 메모리 누수 수정, 보안 강화 |
| v3.5.19 | 녹화 품질 드롭다운 다국어 지원 |
| v3.5.18 | 자동 녹화 품질 설정 통합 - 수동/자동 녹화 품질 통일 |
| v3.5.16 | 자동 녹화 안정성 개선 |
| v3.5.14 | Storage 기반 녹화 상태 영속화 |
| v3.5.12 | 닉네임 자동 업데이트, 방송국 바로가기 |
