...
SOOP(구 아프리카TV) 스트리머 방송 알림, 녹화, 채팅 수집 Chrome 확장 프로그램
...
| **고품질 녹화** | H.264 하드웨어 가속, 최대 4개 동시 녹화 |
| **자동 녹화** | 방송 시작 시 자동 녹화 시작 |
| **안전 저장** | 방송 종료 시 녹화 자동 저장 |
| **자동 분할 녹화** | 500MB/1GB/2GB 단위 자동 분할 저장 |
| **💬 채팅 수집** | 실시간 채팅 자동 수집 (SQLite 저장) |
| **💬 채팅 검색** | 스트리머/닉네임/메시지 검색 |
| **💬 채팅 내보내기** | CSV/JSON 형식 내보내기 |
...
### 💬 채팅 수집 사용
1. Side Panel에서 **채팅 탭** 클릭
2. **수집 모드 설정**:
   - 모든 채팅방: 방문하는 모든 방송의 채팅 수집
   - 선택한 스트리머만: 지정한 스트리머의 채팅만 수집
   - 수집 안함: 채팅 수집 비활성화
3. 방송 페이지 방문 시 **자동으로 채팅 수집 시작**
4. 수집된 채팅은 **검색** 및 **내보내기** 가능
...
| 버전 | 주요 변경 |
|------|-----------|
| v5.x | 💬 채팅 수집 기능 (SQLite 저장, 검색, 내보내기) |
