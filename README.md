...
| **녹화 화질 선택** | 고사양(VP9) / 저사양(VP8) 선택 가능 |
| **자동 녹화** | 방송 시작 시 자동 녹화 시작 |
| **안전 저장** | 방송 종료 시 녹화 자동 저장 |
| **자동 분할 녹화** | 500MB 초과 시 자동으로 파일 분할 저장 |
...
### 녹화 사용
1. SOOP 방송 페이지 접속
2. Side Panel의 "현재 시청 중" 섹션에서 **녹화 화질 선택** (고사양/저사양)
3. 카드에서 **🔴 녹화 시작** 클릭
...
| 설정 | 코덱 | 권장 동시 녹화 | 특징 |
|------|------|----------------|------|
| **고사양** | VP9 | 1~2개 | 고화질, CPU 부하 높음 |
| **저사양** | VP8 | 3~4개 | 안정적, CPU 부하 낮음 |
...
| 버전 | 주요 변경 |
|------|-----------|
| v3.5.3 | 분할 녹화 재생 호환성 수정 (MediaRecorder 재시작 방식), 코드 일관성 개선 |
